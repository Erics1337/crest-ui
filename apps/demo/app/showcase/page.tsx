    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-sand-100">
      <div className="mx-auto max-w-6xl px-4 py-10 space-y-10">
        <header className="space-y-2">
          <h1 className="text-4xl font-display">Crest Code Creative</h1>
          <p className="text-peak-950/70">
            A curated showcase of Crest UI components with practical, cohesive examples.
          </p>
          <div className="pt-2">
            <Link href="/" className="text-sm text-crest-blue-600 hover:underline">
              ← Back to home
            </Link>
          </div>
        </header>
        ...
        <section>
          <Footer>
            <FooterInner>
              <FooterCol>
                <h4 className="text-sm font-semibold">Crest</h4>
